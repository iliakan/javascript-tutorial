...
Вызов `elem.querySelector(css)` возвращает не все, а только первый элемент, соответствующий CSS-селектору `css`, или `null`,  если нет найденых совпадений.

CSS псевдо-классы никогда не вернут киких-либо элементов.
