describe("throttle(f, 1000)", function() {
  ...
  it("тормозит второе срабатывание до 1000 мс", function() {
    ...
    this.clock.tick(1000); // прошло 1000 мс времени
    assert.equal(log, "13"); // log==13, т.к. сработал вызов f1000(3)
  });

  it("тормозит третье срабатывание до 1000 мс после второго", function() {
    this.clock.tick(100);
