...
The second variant is easier to understand isn't it? Instead of the piece of code, we see a name of the action (`isPrime`). Sometimes people refer to such code as *self-describing*.
